        ...
        if (loading) {
            ...
            return (
                ...
                <div margin='25px'>
                      ...
                      <SalesEditPopup open={opensales}custom={custom} cust={customer} prodct={products} stre={stores} editPopupFunction={this.editPopupFunction} customerName={cus1} productName={prd1} storeName={str1} soldDate={dat1} saleId={id} custid={customerid1} prodid={productid} storeid={storeid1} />
